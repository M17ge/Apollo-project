...
/// sees an overview of the what is wanted
...
class _CartpageWidgetState extends State<CartpageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().VATprice = FFAppState().VATprice + 1.0;
      FFAppState().grossPrice = FFAppState().grossPrice + 1.0;
      safeSetState(() {});
    });
  }
                            ...
                            Builder(
                              builder: (context) {
                                ...
                                return ListView.separated(
                                  ...
                                  itemCount: productordercontent.length,
                                  separatorBuilder: (_, __) =>
                                      SizedBox(height: 16.0),
                                  itemBuilder:
                                      (context, productordercontentIndex) {
                                    final productordercontentItem =
                                        productordercontent[
                                            productordercontentIndex];
                                    return Container(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    FFAppState().totalPrice.toString(),
                                    '0 KES',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
