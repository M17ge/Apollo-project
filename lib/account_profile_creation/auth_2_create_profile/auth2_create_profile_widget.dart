            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        'assets/images/Apollo_LOGO___Lime.png',
                        width: 200.0,
                        height: 200.0,
                        fit: BoxFit.fitWidth,
                      ),
                ...
                Padding(
                  ...
                  child: FutureBuilder<List<FarmersRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<FarmersRecord> containerFarmersRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final containerFarmersRecord =
                          containerFarmersRecordList.isNotEmpty
                              ? containerFarmersRecordList.first
                              : null;
                        ...
                        child: Padding(
                          ...
                          child: wrapWithModel(
                            ...
                            child: EditProfileAuth2Widget(
                              isEditing: containerFarmersRecord!,
                            ),
                          ),
                        ),
                      ).animateOnPageLoad(
