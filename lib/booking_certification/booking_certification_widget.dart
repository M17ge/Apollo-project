...
import 'booking_certification_model.dart';
export 'booking_certification_model.dart';

class BookingCertificationWidget extends StatefulWidget {
  const BookingCertificationWidget({super.key});

  static String routeName = 'BookingCertification';
  static String routePath = '/bookingCertification';

  @override
  State<BookingCertificationWidget> createState() =>
      _BookingCertificationWidgetState();
}

class _BookingCertificationWidgetState
    extends State<BookingCertificationWidget> {
  late BookingCertificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingCertificationModel());
