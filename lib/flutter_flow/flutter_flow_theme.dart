...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA4D08A);
  late Color secondary = const Color(0xFFD7AD61);
  late Color tertiary = const Color(0xFFB6CD01);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFF2B8B3C);
  late Color secondaryBackground = const Color(0xFF74A679);
  late Color accent1 = const Color(0xFFDCAB5E);
  late Color accent2 = const Color(0xFF661148);
  late Color accent3 = const Color(0xFF679142);
  late Color accent4 = const Color(0xFF1B3838);
  late Color success = const Color(0xFF60B6D1);
  late Color warning = const Color(0xFFFFC107);
  late Color error = const Color(0xFFF44336);
  late Color info = const Color(0xFF57D8B1);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color tertiary = const Color(0xFF4A148C);
  late Color alternate = const Color(0xFF212121);
  late Color primaryText = const Color(0xFFE8F5E9);
  late Color secondaryText = const Color(0xFF9CCC65);
  ...
  late Color accent3 = const Color(0xFF4A148C);
  late Color accent4 = const Color(0xFFFF9800);
